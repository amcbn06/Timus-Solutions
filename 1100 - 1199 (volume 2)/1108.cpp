...
Strategy:
If the remaining portion of the whole heritage is 1/X, we'll give
the current relative 1/(X+1), and we'll be left with 1/X(X+1)
Because we'll basically approximatively square x each time, we'll
need long arithmetics in order to compute the numbers
